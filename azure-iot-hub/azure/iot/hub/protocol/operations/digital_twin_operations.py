...
class DigitalTwinOperations(object):
    ...
    def update_digital_twin(
            self, digital_twin_id, digital_twin_patch, if_match=None, custom_headers=None, raw=False, **operation_config):
    ...
    def invoke_component_command(
        ...
        return deserialized
    invoke_component_command.metadata = {'url': '/digitalTwins/{digitalTwinId}/interfaces/{interfaceName}/commands/{commandName}'}
