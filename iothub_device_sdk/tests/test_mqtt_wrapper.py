...
#     return MQTTProvider(device_id, hostname, state_machine)
#
#
...
#     with pytest.raises(ValueError, message="Expecting ValueError",
#                        match="Can not instantiate MQTT broker. Incomplete values."):
#         MQTTProvider(None, None, None)
#
#
# def test_create_none_empty_input():
#     with pytest.raises(ValueError, message="Expecting ValueError",
#                        match="Can not instantiate MQTT broker. Incomplete values."):
#         MQTTProvider(None, "", None)
#
#
# def test_create(state_machine):
#     wrapper = MQTTProvider(device_id, hostname, state_machine)
