...
Further samples with more complex IoT Edge scenarios involving IoT Edge modules are contained in the [advanced-edge-scenarios](advanced-edge-scenarios) directory, including:
