...
class IoTHubPipeline(object):
    def __init__(self, auth_provider, pipeline_configuration):
        ...
        self._pipeline = (
            ...
            .append_stage(pipeline_stages_iothub.ConvertTwinOpToRequestAndResponseStage())
            .append_stage(pipeline_stages_base.CoordinateRequestAndResponseStage())
            .append_stage(pipeline_stages_iothub_mqtt.ConvertFromIoTHubOpToMQTTStage())
            .append_stage(pipeline_stages_base.RetryOnErrorStage())
            .append_stage(pipeline_stages_base.AddTimeoutStage())
            .append_stage(pipeline_stages_base.ConnectForOpsThatNeedItStage())
            .append_stage(pipeline_stages_base.BlockWhileConnectingOrDisconnectingStage())
