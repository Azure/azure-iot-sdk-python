...
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_base.Connect,
    module=this_module,
    positional_arguments=[],
    keyword_arguments={"callback": None},
)
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_base.Disconnect,
    module=this_module,
    positional_arguments=[],
    keyword_arguments={"callback": None},
)
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_base.Reconnect,
    module=this_module,
    positional_arguments=[],
    keyword_arguments={"callback": None},
)
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_base.EnableFeature,
    module=this_module,
...
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_base.DisableFeature,
    module=this_module,
    positional_arguments=["feature_name"],
    keyword_arguments={"callback": None},
    extra_defaults={"needs_connection": True},
