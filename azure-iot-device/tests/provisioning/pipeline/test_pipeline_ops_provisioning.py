...
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_provisioning.SetSymmetricKeySecurityClient,
    module=this_module,
    positional_arguments=["security_client"],
    keyword_arguments={"callback": None},
)
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_provisioning.SetSecurityClientArgs,
    module=this_module,
    positional_arguments=["provisioning_host", "registration_id", "id_scope"],
    keyword_arguments={"callback": None},
)
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_provisioning.SendRegistrationRequest,
    module=this_module,
...
pipeline_data_object_test.add_operation_test(
    cls=pipeline_ops_provisioning.SendQueryRequest,
    module=this_module,
