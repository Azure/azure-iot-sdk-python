...
| Retry policies                                                                                                   | :heavy_check_mark:         | :heavy_check_mark:  | :heavy_minus_sign:       | Retry policy for unsuccessful device-to-cloud messages have two options: no try, exponential backoff with jitter (default).                                                                                          |
