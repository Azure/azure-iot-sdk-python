...
class TestConnectDisconnect(object):
    ...
    async def test_connect_disconnect(self, session_object, leak_tracker):
...
class TestConnectDisconnectDroppedConnection(object):
    ...
    async def test_disconnect_on_drop_outgoing(self, dropper, session_object, leak_tracker):
        """
        ...
        assert session_object.disconnected is False
